range 0 src mac start 12:22:97:eb:54:2f
range 0 dst mac start 12:00:c1:fa:ca:91

range 0 src ip start 10.0.0.170
range 0 src ip inc 0.0.0.0
range 0 src ip min 10.0.0.170
range 0 src ip max 10.0.0.170

range 0 dst ip start 10.0.0.235
range 0 dst ip inc 0.0.0.0
range 0 dst ip min 10.0.0.235
range 0 dst ip max 10.0.0.235
